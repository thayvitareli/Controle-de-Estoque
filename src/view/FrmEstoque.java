...
public class FrmEstoque extends javax.swing.JFrame {
    ...
    public FrmEstoque() {
        initComponents();
        setExtendedState(FrmEstoque.NORMAL);
    }
    ...
    private void initComponents() {
        ...
        tabelaProdutos1.setModel(new javax.swing.table.DefaultTableModel(new Object[][]{}, new String[]{"Código", "Nome", "Quantidade", "Preço"}));
        ...
        tabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(new Object[][]{}, new String[]{"Código", "Nome", "Quantidade", "Preço"}));
    ...
    private void btnSalvarReposicaoActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            if (encontrou == 0) {
                JOptionPane.showMessageDialog(null, "Código não encontrado, verifique o c�digo digitado");
            }
        } catch (Exception error) {
            // tratar excecao
            JOptionPane.showMessageDialog(null, "Erro!\nVerifique se os campos foram preenchidos corretamente");
